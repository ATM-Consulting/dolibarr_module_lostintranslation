...
/**
 *	\file		lib/lostintranslation.lib.php
 *	\ingroup	lostintranslation
 *	\brief		This file is an example module library
 *				Put some comments here
 */

function lostintranslationAdminPrepareHead()
{
    global $langs, $conf;
    ...
    //$this->tabs = array(
    //	'entity:+tabname:Title:@lostintranslation:/lostintranslation/mypage.php?id=__ID__'
    //); // to add new tab
    //$this->tabs = array(
    //	'entity:-tabname:Title:@lostintranslation:/lostintranslation/mypage.php?id=__ID__'
    //); // to remove a tab
    complete_head_from_modules($conf, $langs, $object, $head, $h, 'lostintranslation');
